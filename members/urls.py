...
from .views import UpdateProfileView,SetAvailabilityView,RegisterMemberView,LoginView,GETallMembersView,MemberInfoView,RoleViewAPI,SearchUserView,SingleImageUploadView
